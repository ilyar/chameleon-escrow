...
func main() {
	...
	words := strings.Split("oven verify dynamic smile scare athlete element outdoor shift injury sell poet violin unknown unfair artefact decade silk orient save diary loop addict transfer", " ")
	...
	if balance.Nano().Uint64() >= 3000000 {
		...
		log.Printf(
			...
			block.SeqNo, base64.StdEncoding.EncodeToString(tx.Hash), balance.String(),
		)
